...
from public_tech_lib.file_processing_service.third_party_lib.docling.backend.abstract_backend import DeclarativeDocumentBackend
...
class PubMedDocumentBackend(DeclarativeDocumentBackend):
    """
    The code from this document backend_temp has been developed by modifying parts of the PubMed Parser library (version 0.5.0, released on 12.08.2024):
    ...
    def __init__(self, in_doc: "InputDocument", path_or_stream: Union[BytesIO, Path]):
        ...
        try:
            ...
            raise RuntimeError(
                f"Could not initialize PubMed backend_temp for file with hash {self.document_hash}."
            ) from exc
