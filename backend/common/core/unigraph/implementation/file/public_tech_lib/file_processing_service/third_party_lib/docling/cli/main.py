...
from public_tech_lib.file_processing_service.third_party_lib.docling.backend.docling_parse_backend import DoclingParseDocumentBackend
from public_tech_lib.file_processing_service.third_party_lib.docling.backend.docling_parse_v2_backend import DoclingParseV2DocumentBackend
from public_tech_lib.file_processing_service.third_party_lib.docling.backend.pdf_backend import PdfDocumentBackend
from public_tech_lib.file_processing_service.third_party_lib.docling.backend.pypdfium2_backend import PyPdfiumDocumentBackend
from public_tech_lib.file_processing_service.third_party_lib.docling.datamodel.base_models import (
    ConversionStatus,
    FormatToExtensions,
    InputFormat,
    OutputFormat,
...
from public_tech_lib.file_processing_service.third_party_lib.docling.document_converter import DocumentConverter, FormatOption, PdfFormatOption
...
def convert(
    ...
    pdf_backend: Annotated[
        PdfBackend, typer.Option(..., help="The PDF backend_temp to use.")
    ...
    with tempfile.TemporaryDirectory() as tempdir:
        ...
        if pdf_backend == PdfBackend.DLPARSE_V1:
            ...
            raise RuntimeError(f"Unexpected PDF backend_temp type {pdf_backend}")
