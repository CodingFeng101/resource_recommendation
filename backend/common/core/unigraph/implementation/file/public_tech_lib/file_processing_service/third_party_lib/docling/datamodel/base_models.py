...
if TYPE_CHECKING:
    from public_tech_lib.file_processing_service.third_party_lib.docling.backend.pdf_backend import PdfPageBackend
...
class InputFormat(str, Enum):
    """A document format supported by document backend_temp parsers."""
...
class Page(BaseModel):
    ...
    _backend: Optional["PdfPageBackend"] = (
        None  # Internal PDF backend_temp. By default it is cleared during assembling.
    )
