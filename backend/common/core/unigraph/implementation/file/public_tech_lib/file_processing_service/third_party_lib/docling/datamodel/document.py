...
from public_tech_lib.file_processing_service.third_party_lib.docling.backend.abstract_backend import (
...
from public_tech_lib.file_processing_service.third_party_lib.docling.datamodel.settings import DocumentLimits
from public_tech_lib.file_processing_service.third_party_lib.docling.utils.profiling import ProfilingItem
from public_tech_lib.file_processing_service.third_party_lib.docling.utils.utils import create_file_hash, create_hash

if TYPE_CHECKING:
    from public_tech_lib.file_processing_service.third_party_lib.docling.document_converter import FormatOption
...
class InputDocument(BaseModel):
    ...
    _backend: AbstractDocumentBackend  # Internal PDF backend_temp used
